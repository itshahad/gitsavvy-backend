...
MAX_LINES_NUM = int(os.getenv("MAX_LINES_NUM", 10))
OVERLAPPING_LINES_NUM = int(os.getenv("OVERLAPPING_LINES_NUM", 3))
MIN_TAIL_LINES = int(os.getenv("MIN_TAIL_LINES", 3))
MAX_FUNC_SPLITTING_DEPTH = int(os.getenv("MAX_FUNC_SPLITTING_DEPTH", 2))
